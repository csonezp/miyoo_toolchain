...
static const char configuration_arguments[] = "./configure --prefix=/opt/miyoo --sysconfdir=/opt/miyoo/etc --enable-static --target=arm-miyoo-linux-uclibcgnueabi --with-sysroot=/opt/miyoo/arm-miyoo-linux-uclibcgnueabi/sysroot --disable-__cxa_atexit --with-gnu-ld --disable-libssp --disable-multilib --with-gmp=/opt/miyoo --with-mpc=/opt/miyoo --with-mpfr=/opt/miyoo --with-pkgversion='Buildroot 2018.02' --with-bugurl=http://bugs.buildroot.net/ --disable-libquadmath --disable-libsanitizer --enable-tls --enable-plugins --enable-lto --disable-libmudflap --enable-threads --without-isl --without-cloog --with-float=soft --disable-decimal-float --with-abi=aapcs-linux --with-cpu=arm926ej-s --with-float=soft --with-mode=arm --enable-languages=c,c++ --with-build-time-tools=/opt/miyoo/arm-miyoo-linux-uclibcgnueabi/bin --enable-shared --disable-libgomp";
